...
?>
    ...
    <center><table class="table table-responsive  table-hover" cellpadding="0" cellspacing="0" border="0">
            <thead><tr>
                    <!--<th>All <input type="checkbox" id="checkall" onclick="return check();" /></th>-->
<th><strong>Name</strong></th><th><strong>Results</strong></th><th><strong>Attendance</strong></th>
     ...
     if($student){
         foreach($student as $n){?>
            <tr>
                ...
                <td><?=$n->studname;?></td>
                <td><a href="<?php echo base_url()."index.php/SundaySchoolController/viewStudMarks/".$n->studentid ?>">View Results</a></td>
