             ...
             <nav id="colorNav">
			   <ul>
				<li class="green">
				  ...
				  <ul>
					<li><a href="<?php echo base_url();?>index.php/MatrimonyLoginController/login">Login</a></li>
...
<div class="grid_3">
  <div class="container">
      <br><br><br><div class="breadcrumb1">
     <ul>
      ...
      <?php 
          ...
          echo form_open("MatrimonyLoginController/loginProcess", $attributes);?>
   <div class="services">
	   ...
	   <form>
	      ...
	      <label for="edit-name">Username <span class="form-required"  title="This field is required.">*</span></label>
              <input type="text" id="txt_username" name="txt_username" value="" placeholder="Email"  class="form-text required">
	     <span class="text-danger"><?php echo form_error('txt_username'); ?></span>	
            </div>
	    <div class="form-item form-type-password form-item-pass">
	      <label for="edit-pass">Password <span class="form-required" title="This field is required.">*</span></label>
	      <input type="password" id="txt_password" name="txt_password" size="60" placeholder="Password" maxlength="128" class="form-text required">
	    ...
	    <div class="form-actions">
	    	<input type="submit" id="btn_submit" name="btn_submit" value="login" class="btn_1 submit">
	    </div>
	   </form>
	  </div>
	  <!--<div class="col-sm-6">
