    ...
    <!--<div class="navbar navbar-inverse-blue navbar-fixed-top">-->
      <div class="navbar-inner">
        <div class="container">
           ...
           <a class="brand" href="<?php echo base_url();?>index.php/MatrimonyController/index">
...
<div class="banner">
  <div class="container">
    <div class="banner_info">
      ...
      <a href="<?php echo base_url();?>index.php/MatrimonyController/reg" class="hvr-shutter-out-horizontal">Create your Profile</a>
    </div>
