...
?> 
          <div class="well" >
              <center><h3><b>Add church events</b></h3></center>
                   <br>                   <?php echo $this->session->flashdata('msg'); ?>

          <?php 
          $attributes = array("class" => "form-horizontal", "id" => "addChurchEvent", "name" => "addChurchEvent");
          echo form_open("ChurchController/verifyChurchEvents", $attributes);?>
                  <fieldset>
                      <center><table>
                              <tr><td><label for="txt_prayer" class="control-label">Event</label>
                                  <td><input class="form-control" id="txt_prayer" name="txt_prayer" placeholder="" type="text"  list="eventList"  value="<?php echo set_value('txt_prayer'); ?>" />
                                      <datalist id="eventList">
    <option value="Monthly Prayer">
    <option value="Bible study">
        <option value="Convention">
            <option value="Kids annual meet">
                <option value="Ladies Meet">
</datalist>
                    <span class="text-danger">  <?php echo $this->session->flashdata('prayermsg'); ?></span>
               
                              <tr><td><label for="txt_day" class="control-label">Date and time</label>
