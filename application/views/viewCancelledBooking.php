...
<!--<a href="<?php echo base_url();?>index.php/AdminController/viewCancelledBooking" class="BTN BTN-PRIMARY">CANCELLED BOOKINGS </a>-->
</p>
   ...
   <table class="table table-responsive  table-hover" cellpadding="0" cellspacing="0" border="0" >
     ...
     <tr><td><?=$ch->bookid;?></td><td><?=$ch->name;?></td><td><?=$ch->date;?></td><td><?=$ch->amount_payed;?></td><td><?=$ch->balance;?></td><td><?=$ch->status;?></td>
         <td><a href="<?php echo base_url()."index.php/BookingController/approve_booking/".$ch->bookid ?>" class="btn btn-success" >Send Confirmation Mail</a>
