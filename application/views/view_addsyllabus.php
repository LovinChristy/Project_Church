...
<div id="message"><?php echo "<font color='red'>$error</font>";?> <!-- Error Message will show up here --></div>
           ...
           <tr><td><label for="syllabus" class="control-label">Syllabus</label></td>
               <td><input class="form-control" type='file' name='userfile' accept="application/pdf,application/doc" size='20' id='file'/>
                             <span class="text-danger">  <?php echo $this->session->flashdata('syllabusmsg'); ?></span></td></tr>
           
             <tr><td colspan=2>
                    <center><input type='submit' name='submit' value='Upload' class='btn btn-success' />
                    </td></tr>
                       </table>       
          <?php echo form_close(); ?>
                    </fieldset>
