...
?>
            ...
            <center><h4><strong>School tutors of churches</strong></h4>
                <br><br>
    ...
    <center><table class="table table-responsive  table-hover" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr><th><strong>Church</strong></th><th><strong>Tutor</strong></th>
     ...
     if($tutor){
     foreach($tutor as $n){?>
            <tr><td><?=$n->chname;?></td><td> <?= $n->tutor; ?></td><td><?=$n->class;?></td>
