...
<body>
	...
	<div class="banner">
		<div class="head">
            ...
            <a href="<?php echo base_url()."index.php/AdminController/view_evangelist_approved"?>"class="BTN BTN-PRIMARY">APPROVED</a><center>
    ...
    <table class="table table-responsive table-hover" cellpadding="0" cellspacing="0" border="0">
     ...
     <tr>
         ...
         <td><?=$ev->evangelistid;?></td><td><a href="<?php echo base_url()."index.php/AdminController/view_evangelist_details/".$ev->evangelistid;?>"><?=$ev->evname;?></a></td>
         </td><td><a href="<?php echo base_url()."index.php/AdminController/approve_evangelist/".$ev->evangelistid ?>" class="btn btn-success">Approve</a>
</td></tr>     
        <?php }
         }
        else
