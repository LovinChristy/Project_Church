...
?>
            ...
            <center><h4><strong>Exam Notification</strong></h4></center>
                             <?php echo $this->session->flashdata('msg'); ?>

<a href="<?php echo base_url();?>index.php/SundaySchoolController/addExams" class="BTN BTN-PRIMARY">ADD NEW EXAM </a></p>
    ...
    <center><table class="table table-responsive  table-hover" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr><th><strong>Class</strong></th><th><strong>Exam</strong></th>
                <th><strong>Exam Date</strong></th><th><strong>Posted on</strong></th><th colspan="2">Postpone/Hide
