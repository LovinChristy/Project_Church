   ...
   <br>
    ...
    <br><br>
     <?php
                ...
                echo form_open("ChurchController/view_searched_family",$attributes);?>
...
if($family)
{
   foreach($family as $f)
   {
       echo "<table><tr><td>". $f->familyname ." <tr><td>".$f->hofname."<tr><td>Email id:".$f->hofemail."<tr><td>Phone:".$f->phone."<tr><td><a href='viewFamily/$f->hofid'>View Family</a>"."<br><br>";
   }
}
else
{
