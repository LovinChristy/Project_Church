...
?>
            ...
            <center><h4><strong>School Heads of churches</strong></h4>
                <br><br>
    ...
    <center><table class="table table-responsive  table-hover" cellpadding="0" cellspacing="0" border="0">
            ...
            <tr><th><strong>Church</strong></th><th><strong>School Head</strong></th>
     ...
     {
         foreach($head as $n){?>
            <tr><td><?=$n->chname;?></td><td> <?= $n->head; ?></td><td><?=$n->year;?></td>
