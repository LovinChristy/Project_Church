...
<!--					<li><a href="<?php echo base_url();?>index.php/MatrimonyController/login">Login</a></li>
           ...
           <a class="brand" href="<?php echo base_url();?>index.php/HomeController/index"><img src="<?php echo base_url();?>asset/matrimonyimages/logo.png" alt="logo"></a>
...
<!--  <div class="breadcrumb1">
     <ul>
        <a href="<?php echo base_url();?>index.php/MatrimonyController/matrimonyHome"><i class="fa fa-home home_1"></i></a>
      ...
      <br><br><?php
echo "<center><font color='#FFFFFF' size='7'>Welcome ".$this->session->userdata('username');
?>
 </div>
  </div>
</div>
