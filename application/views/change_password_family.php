...
<body >
  ...
  <br><br> <br><br>
        <div class="wthree-form">
          ...
          echo form_open("FamilyMainController/checkoldpswd", $attributes);?>
...
<!--				<div class="form-sub-w3">
                    ...
                    <div class="form-sub-w3">
                        <input class="form-control" id="oldpassword" name="oldpassword" placeholder="Old Password" required="" type="password" value="<?php echo set_value('old_password'); ?>" />
                    <span class="text-danger"><?php echo form_error('oldpassword'); ?></span>
                    </div>
                    <div class="form-sub-w3">
                        <input class="form-control" id="new_password" name="new_password" placeholder="New Password" required="" type="password" value="<?php echo set_value('new_password'); ?>" />
                    <span class="text-danger"><?php echo form_error('new_password'); ?></span>
                    </div>
                    <div class="form-sub-w3">
                        <input class="form-control" id="new_password" name="retype_password" placeholder="Confirm Password" required="" type="password" value="<?php echo set_value('retype_password'); ?>" />
