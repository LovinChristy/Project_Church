...
<center><div class="container" style="width:80%;margin:4px; height:70%; overflow-x:auto;">
     <center><h4>Approved Family Records</h4>
         <a href="<?php echo base_url();?>index.php/ChurchController/view_family" class="btn btn-primary">REGISTERED </a>
                                     <a href="<?php echo base_url();?>index.php/ChurchController/viewChurchFamily" class="btn btn-warning">APPROVED</a>
         ...
         <table class="table table-striped table-bordered">
             <thead> <tr><th><strong>ID</strong></th><th><strong>Family</strong></th><th><strong>Name</strong></th>
                     <th><strong>Reject</strong></th></thead>
<?php
if($chfam){

foreach($chfam as $cf)
{?>
             <tr><td><?=$cf->hofid;?></td><td><a href="<?php echo base_url()."index.php/ChurchController/viewFamily/".$cf->hofid;?>" ><?=$cf->familyname;?></a></td><td><?=$cf->hofname;?></td>
<td><a href="<?php echo base_url()."index.php/ChurchController/reject_family/".$cf->hofid ?>" class="btn btn-success">Reject</a>
</tr>     
        <?php }
        }
        else
