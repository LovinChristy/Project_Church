   ...
   <br>
    ...
    <br><br>
     <?php
                ...
                echo form_open("FamilyMainController/view_searched_family",$attributes);?>
                <div class="col-lg-7 in-gp-tb">
							...
							<select name="search" id="search" class="form-control">
                                                            ...
                                                            <?php
                                                         foreach($familyall as $c){
                                                          ?>
                                                                <option value<?=$c->hofid;?>>
                                                                <?php echo $c->familyname;?></option>
...
if($family)
{
   foreach($family as $f)
   {
       echo "<table><tr><td>". $f->familyname ." <tr><td>".$f->hofname."<tr><td>Email id:".$f->hofemail."<tr><td>Phone:".$f->phone."<tr><td><a href='viewFamilyDetails/$f->hofid'>View Family</a>"."<br><br>";
   }
}
else
{
    echo "<tr><td>No results found";
}
echo "</td></tr></table>"
?>
