...
?>
 ...
 <a href="<?php echo base_url()."index.php/SundaySchoolController/addsyllabus" ?>"><img src="<?php echo base_url();?>asset/images/add.png"> Add New</a>
                                <a href="<?php echo base_url()."index.php/SundaySchoolController/updateSyllabus" ?>"><img src="<?php echo base_url();?>asset/images/edit.png"> Update</a>
    ...
    <center><table class="table table-responsive  table-hover" cellpadding="0" cellspacing="0" border="0">
            ...
            <thead><tr><th><strong>Class</strong></th><th><strong>Syllabus</strong></th><th><strong>Modified on</strong></th>
     ...
     foreach($syllabus as $n){?>
            <tr><td><?=$n->class;?></td><td> <a href="#" ><?= $n->file; ?></a></td><td><?=$n->dateadded;?></td>
