...
<div class="container" style="min-height:100%">
    ...
    <?php 
          ...
          echo form_open("FamilyMainController/updateMemberData", $attributes);
    ?>
...
if($mp){
    foreach($mp as $row){?>
        <input type="text" hidden="" id="mpid" name="mpid" value="<?php echo $row->mpid ; ?>">
 <tr><td>
        <?php echo "Name:" ?><td><input type="text" name="mname" value="<?php  echo $row->membername ?>"></td>
   
    <tr><td>
        <?php echo "Job:"?><td><input type="text" name="job" value="<?php echo $row->occupation?>"></td>
    <tr><td>
        <?php echo "Email id:"?><td><input type="email" name="email" value="<?php echo $row->member_email?>" ></td>
    <tr><td>
        <?php echo "Contact Number:"?><td><input type="text" name="phone" value="<?php echo $row->mem_phone?>"></td>
    <tr><td colspan="2">
