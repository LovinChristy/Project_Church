	...
	<div class="a-grid">
     ...
     <center>    <a href="http://localhost/BrethrenChurch/index.php/DownloadController/downloadschoolapp" class="btn btn-warning" style=" width:170px;height:50px;"> <font size="3px" face="Lobster"> Schools </a>
                            ...
                            <div class="col-md-12 agile_banner_bottom1_right" style="background:#FFFFFF;">
                                ...
                                <span style="color:red;">* </span> TMM Hospital College of Nursing<br>
                          &nbsp;&nbsp;&nbsp;<a href="<?=base_url ()?>index.php/DownloadController/download/MCA404OOMD_QP.pdf" class="btn btn-primary"> Download application</a>
            
				<br><br>
                                <span style="color:red;">* </span>  Thiruvalla Hope Academy of Theology and Sciences(HATS), Bhopal
                          <br>&nbsp;&nbsp;&nbsp;<a href="<?=base_url ()?>index.php/DownloadController/download/MCA404OOMD_QP.pdf" class="btn btn-primary"> Download Application</a>
            
				<br><br>
                                <span style="color:red;">* </span>   Madurai Bible School & College, Madurai
                         <br> &nbsp;&nbsp;&nbsp;<a href="<?=base_url ()?>index.php/DownloadController/download/MCA404OOMD_QP.pdf" class="btn btn-primary"> Download application</a>
            
				<br><br>
                                <span style="color:red;">* </span>  Brethren Bible Institute, Pathanamthitta (Offering B.Th., M.B.S., M.Div. & M.Th.)
                          ...
                          <br>&nbsp;&nbsp;&nbsp;<a href="<?=base_url ()?>index.php/DownloadController/download/MCA404OOMD_QP.pdf" class="btn btn-primary"> Download application</a>
                                ...
                                <!--&nbsp;&nbsp;&nbsp;<span style="color:red;">* </span> <a href="<?=base_url ()?>index.php/DownloadController/download_song" > Songs </a>-->
