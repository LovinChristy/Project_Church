...
<div class="wrapper">
    <div class="container">
        <div class="reg" style="width:50%;" >
                ...
                echo form_open("dorc_ctrl/netBanking",$attributes);?>
                           <div class="form-box">
         
            <div class="panel-heading text-center">
                <hr></hr><center><strong><h1><b>Your entered details<b></h1></strong></center><hr></hr>
                 </div>
            ...
            <div class="panel-body">
              <div class="row">
                        ...
                        <div class="col-md-6">
                              ...
                              <div class="col-md-2">
                                  ...
                                  <input type="text" readonly=""  placeholder="" class="input-xlarge"
                                         ...
                                         <div class="form-sub-w3">
                        <div class="col-md-6">
                                     <label class="control-label" style="font-weight: bold;" for="username"><font size="2px">Bank </label> </div>
                              <div class="col-md-2">
                                  
                                  <input type="text" readonly=""  placeholder="" class="input-xlarge"
                                                            id="bank" name="bank" value="<?php echo $this->session->flashdata('bank') ?>" > 
                ...
                <center> <div class="submit">
                        <center>	 <input id="book" name="book" type="submit"  value="CONTINUE"  /></center>
