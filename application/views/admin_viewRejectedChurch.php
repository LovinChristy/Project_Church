...
<body>
    ...
    if($(this).prop('checked')){
        ...
        $(' tr td input[type="checkbox"]').each(function(){
            $(this).prop('checked', false);
                        ...
                        <a href="<?php echo base_url()."index.php/AdminController/view_church"?>"class="BTN BTN-PRIMARY">REGISTRATIONS</a>
    ...
    <table class="table table-responsive  table-hover" cellpadding="0" cellspacing="0" border="0" >
     ...
     if($church){
         ...
         ?>
     <tr><td><?=$ch->chid;?></td><td><?=$ch->chname;?></td><td><?=$ch->secretaryname;?></td><td><?=$ch->chemail;?></td>
</td><td><a href="<?php echo base_url()."index.php/AdminController/approve_church/".$ch->chid ?>" class="btn btn-success" >Approve</a>
</td>
