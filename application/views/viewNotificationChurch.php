...
<body>
	...
	<div class="banner">
		<div class="head">
			<div class="container">
                 ...
                 <center><h4>Public Notices</h4>
            <div style="width:80%;margin:20px; height:70%; overflow-x:auto;">
               
    <?php echo $this->session->flashdata('msg'); ?>
                <a href="<?php echo base_url();?>index.php/ChurchController/churchNotification" class="btn btn-warning">Public Notifications </a>||
    ...
    <center><table class="table table-striped table-bordered" >
     <tr><td><strong>#</strong></td><td><strong>Title</strong></td><td><strong>Notification</strong></td><td><strong>Posted Date & Time</strong></td>
        
     <?php
     if($notification)
     {
         $i=1;foreach($notification as $n){?>
