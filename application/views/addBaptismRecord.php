...
?> 
          <div class="well" >
              <center><h3><b>Add church baptism</b></h3></center>
                   <br>
          <?php 
          $attributes = array("class" => "form-horizontal", "id" => "addChurchBaptism", "name" => "addChurchBaptism");
          echo form_open("RecordsController/verifyChurchBaptism", $attributes);?>
                  <fieldset>
                      <center><table>
                    ...
                    <span class="text-danger">  <?php echo $this->session->flashdata('officiantmsg'); ?></span>
                              ...
                              <tr><td><label for="txt_membername" class="control-label">Member Name</label>
                                  <td><input class="form-control" id="txt_membername" name="txt_membername" placeholder="" type="text" value="<?php echo set_value('txt_membername'); ?>" />
                    <span class="text-danger">  <?php echo $this->session->flashdata('membernamemsg'); ?></span>
               <tr ><td colspan=2>
                    <center><input id="btn_chprayerbaptism" name="btn_chprayerbaptism" type="submit" class="btn btn-warning" value="Post" />
